...
export const mockTransactions: Transaction[] = [
  ...
  { id: 'T3', type: 'expense', source: 'Carburant - TotalEnergies', amountExVat: 50.00, vatRate: 21, totalAmount: 60.50, vatAmount: 10.50, date: '2024-07-17', paymentMethod: 'Card' },
  ...
  { id: 'T5', type: 'expense', source: 'Abonnement Téléphone', amountExVat: 25.00, vatRate: 21, totalAmount: 30.25, vatAmount: 5.25, date: '2024-07-20', paymentMethod: 'Bank Transfer' },
  { id: 'T6', type: 'expense', source: 'Entretien voiture', amountExVat: 150.00, vatRate: 21, totalAmount: 181.50, vatAmount: 31.50, date: '2024-08-02', paymentMethod: 'Card' },
...
export const mockInvoices: Invoice[] = [
  { id: 'I1', invoiceNumber: 'INV-2024-0001', clientName: 'Client A', clientAddress: '123 Rue de Bruxelles, 1000 Bruxelles', serviceDescription: 'Web Development', amountExVat: 1500, vatRate: 21, totalAmount: 1815, issueDate: '2024-07-10', dueDate: '2024-07-25', status: 'Payée' },
